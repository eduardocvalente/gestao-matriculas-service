...
public sealed class MatriculaCanceladaEvent : IDomainEvent
{
    ...
    public MatriculaCanceladaEvent(Guid matriculaId, Guid alunoId, Guid disciplinaId, PeriodoLetivo periodo)
    {
